...
public final class SimpleGrpc {
  ...
  public static final String SERVICE_NAME = "essam.com.example.Shift.Application.Simple";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<essam.com.example.Shift.Application.grpc.HelloRequest,
      essam.com.example.Shift.Application.grpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = essam.com.example.Shift.Application.grpc.HelloRequest.class,
      responseType = essam.com.example.Shift.Application.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<essam.com.example.Shift.Application.grpc.HelloRequest,
      essam.com.example.Shift.Application.grpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<essam.com.example.Shift.Application.grpc.HelloRequest, essam.com.example.Shift.Application.grpc.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<essam.com.example.Shift.Application.grpc.HelloRequest, essam.com.example.Shift.Application.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "essam.com.example.Shift.Application.Simple", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  essam.com.example.Shift.Application.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  essam.com.example.Shift.Application.grpc.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(essam.com.example.Shift.Application.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<essam.com.example.Shift.Application.grpc.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                essam.com.example.Shift.Application.grpc.HelloRequest,
                essam.com.example.Shift.Application.grpc.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractStub<SimpleBlockingStub> {
    ...
    /**
     */
    public essam.com.example.Shift.Application.grpc.HelloReply sayHello(essam.com.example.Shift.Application.grpc.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractStub<SimpleFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<essam.com.example.Shift.Application.grpc.HelloReply> sayHello(
        essam.com.example.Shift.Application.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((essam.com.example.Shift.Application.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<essam.com.example.Shift.Application.grpc.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return essam.com.example.Shift.Application.grpc.Gigs.getDescriptor();
    }
